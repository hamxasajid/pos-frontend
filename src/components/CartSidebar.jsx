...
const CartSidebar = ({ isOpen, onClose, onCheckout }) => {
    ...
    const { subtotal, tax, total } = useMemo(() => calculateTotal(cartItems, discount), [cartItems, discount]);
      ...
      `}>
                ...
                <div className="p-6 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 space-y-3 pb-8 flex-shrink-0">
                    ...
                    <div className="flex justify-between items-end mb-4">
                        ...
                        <span className="text-3xl font-bold text-gray-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
